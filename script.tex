...
\begin{proof}
	...
	\langle \psi,e^{-\beta K_{\mu}}\psi\rangle &={N}^{-1}\langle \psi , e^{-\beta K_{\mu}}bThe CAR algebra is faithfully represented on F a ( H ) {\displaystyle F_{a}(H)} F_{a}(H) by setting(\varphi)\mathcal{N}\psi\rangle\\
